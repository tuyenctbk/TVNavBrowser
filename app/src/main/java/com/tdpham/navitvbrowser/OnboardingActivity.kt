...
class OnboardingActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        FirebaseInitializer.logEvent("onboarding_started")
        ...
        btnSkip.setOnClickListener { completeOnboarding(skipped = true) }
    ...
    private fun updateStep(animate: Boolean) {
        ...
        if (animate) {
            FirebaseInitializer.logEvent("onboarding_step_changed", mapOf("step" to currentStep + 1))
    ...
    private fun completeOnboarding(skipped: Boolean) {
        ...
        FirebaseInitializer.logEvent(if (skipped) "onboarding_skipped" else "onboarding_completed")
